...
void UUI_WindowManager::CreateWindow(EWindowWidgetType _type)
{
...
void UUI_WindowManager::OpenWindow(EWindowWidgetType _type, bool _is_open)
{
	auto data_ptr = _WindowDataMap.Find(_type);
...
void UUI_WindowManager::OnWindowFocused(UWindowBase* _focused_window_widget, bool _is_focused)
{
...
FVector2D UUI_WindowManager::GetNextWindowPosition() const
{
	UWindowBase* top_window = GetTopWindow();
...
void UUI_WindowManager::InitializeWindowWidget(UWindowBase* _window_widget, EWindowWidgetType _type, const FVector2D& _window_pos)
{
	...
	_window_widget->_OnWindowFocusedEvent.RemoveDynamic(this, &UUI_WindowManager::OnWindowFocused);
	_window_widget->_OnWindowFocusedEvent.AddDynamic(this, &UUI_WindowManager::OnWindowFocused);
}

void UUI_WindowManager::AttachWindowToCanvas(UWindowBase* _window_widget)
{
...
void UUI_WindowManager::CreateWindowTab(EWindowWidgetType _type, FWindowData& _window_data)
{
	...
	window_tab->_OnClicked.AddDynamic(this, &UUI_WindowManager::OnClickWindowTab);
