...
void ALobbyPawn::SetupPlayerInputComponent(UInputComponent* _input_component)
{
	...
	enhanced_input_comp->BindAction(_IA_Interact, ETriggerEvent::Started, this, &ALobbyPawn::Input_Interact);

	enhanced_input_comp->BindAction(_IA_LeftMouseClick, ETriggerEvent::Started, this, &ALobbyPawn::Input_LeftMouseButtonStarted);
	enhanced_input_comp->BindAction(_IA_LeftMouseClick, ETriggerEvent::Completed, this, &ALobbyPawn::Input_LeftMouseButtonCompleted);
	enhanced_input_comp->BindAction(_IA_MouseWheel, ETriggerEvent::Triggered, this, &ALobbyPawn::Input_MouseWheel);
}
...
void ALobbyPawn::Input_Interact(const FInputActionValue& _value)
{
...
void ALobbyPawn::Input_LeftMouseButtonStarted()
{
...
void ALobbyPawn::Input_LeftMouseButtonCompleted()
{
	if (IsValid(WidgetInteractionComponent->GetHoveredWidgetComponent()))
	{
...
void ALobbyPawn::Input_MouseWheel(const FInputActionValue& _value)
{
...
void ALobbyPawn::DriveWidgetInteraction(float _delta_time)
{
