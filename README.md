...
- Details picker는 `RequiredAssetDataTags`로 RowStructure를 필터링한다.
...
- `_ItemTables` picker의 RowStructure 필터가 프로젝트 파생 RowStruct를 잘 보여주는지 에디터에서 확인해야 한다.
...
14. `Source/ItemCoreEditor/Private/ItemIDCustomization.cpp`
15. `Source/ItemCoreEditor/Private/K2Node_MakeItemID.cpp`
16. `Source/ItemCoreEditor/Private/ItemCoreEditor.cpp`
